...
<head>
  <meta charset="UTF-8">
  <title>Admin - Manejar información de los tours de Bogotá</title>
...
<body>
  <div class="container mt-5">
    <h1>Manejar información de los tours de Bogotá</h1>
  ...
  <script>
    const API_URL = "https://multyviajes-backend.onrender.com/api/toursbogota"; // Adjust as needed
